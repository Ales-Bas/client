    ...
    return (
        <nav className={burgerClick ? [styles.navbar, styles.active].join(' ') : [styles.navbar]}>
            <ul>
                ...
                <li onClick={() => onClickMenuItem(1)}><Link to='/' className={activeIndex === 1 ? [styles.menuActive] : ''}>О компании</Link></li>
                <li onClick={() => onClickMenuItem(2)}><Link to='/pkatalog' className={activeIndex === 2 ? [styles.menuActive] : ''}>Техника Doosan</Link></li>
                <li onClick={() => onClickMenuItem(3)}><Link to='/pkatalog' className={activeIndex === 3 ? [styles.menuActive] : ''}>Запчасти Doosan</Link></li>
                <li onClick={() => onClickMenuItem(4)}><Link to='/' className={activeIndex === 4 ? [styles.menuActive] : ''}>Сервис</Link></li>
                <li onClick={() => onClickMenuItem(5)}><Link to='/' className={activeIndex === 4 ? [styles.menuActive] : ''}>Контакты</Link></li>
            </ul>
