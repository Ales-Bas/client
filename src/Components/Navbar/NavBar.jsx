...
export default function NavBar() {
    ...
    return (
        <nav className={burgerClick ? [styles.navbar, styles.active].join(' ') : [styles.navbar]}>
            <ul>
                <li><NavLink className={({ isActive }) => isActive ? [styles.menuActive] : ""} to='/' >Главная</NavLink></li>
                <li><NavLink className={({ isActive }) => isActive ? [styles.menuActive] : ""} to='/tkatalog' >Техника Doosan</NavLink></li>
                <li><NavLink to='/pkatalog' className={({ isActive }) => isActive ? [styles.menuActive] : ""}>Запчасти Doosan</NavLink></li>
                <li><NavLink to='/service' className={({ isActive }) => isActive ? [styles.menuActive] : ""}>Сервис</NavLink></li>
                <li><NavLink to='/company' className={({ isActive }) => isActive ? [styles.menuActive] : ""}>О компании</NavLink></li>
