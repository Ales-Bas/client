...
import { addPartItems, minusItem, removePartItems } from '../redux/slises/cartSlice';

export default function CartItem({ id, kluch, partsno, description, count, }) {
