                ...
                <div className="company__teazer">
                    <div className="company__teazer__text">
                        ...
                        <p> Мы, официальный дилер и сервис-дилер ООО "Трансмехсервис" дистрибъютера DEVELON
                            (DOOSAN INFRACORE) на территории Российской Федерации. На правах дилера мы осуществляем поставку
                            техники DEVELON (DOOSAN) снабжением запасными частями, обеспечиваем обслуживание и ремонт техники и узлов.
