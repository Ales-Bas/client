...
export default function PKatalog() {
    ...
    React.useEffect(() => {
        //setIsLoading(true);
        axios.get(`http://localhost:5000/api/modelname`)
            .then((res) => {
    ...
    React.useEffect(() => {
        //setIsLoading(true);
        axios.get(`http://localhost:5000/api/subtype`)
            .then((res) => {
    ...
    React.useEffect(() => {
        ...
        axios.get(`http://localhost:5000/api/typepart?${modelnameId}&${subtypepartId}`)
            .then((res) => {
